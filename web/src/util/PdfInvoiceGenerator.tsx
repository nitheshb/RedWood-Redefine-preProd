        ...
        {leadDetailsObj1?.Mobile}
              ...
              <View>
                ...
                >
                  ...
                  <Text style={[{ marginLeft: 15, color: '#6A6A6A' }]}>
                    {' '}
                    {streamUnitDetails?.custObj1?.customerName1}
                  </Text>
                </View>
                ...
                >
                  ...
                  <Text style={[{ marginLeft: 15, color: '#6A6A6A' }]}>
                    {' '}
                    {streamUnitDetails?.custObj1?.phoneNo1}
                  </Text>
                </View>
                ...
                >
                  ...
                  <Text style={[{ marginLeft: 15, color: '#6A6A6A' }]}>
                    {streamUnitDetails?.custObj1?.email1}
                  </Text>
                </View>
              </View>
            </View>
                    ...
                    <View>
                      {myObj?.map((item, index) => (
                        ...
                        >
                          ...
                          <View
                            style={[styles.tableCell_15, styles.alignRight]}
                          >
                            <Text>
                          ...
                          >
                            <Text>
                              ₹ {item?.TotalSaleValue?.toLocaleString('en-IN')}
                            </Text>
                          </View>
                          ...
                          >
                            <Text>
                              ₹ {item?.gstValue?.toLocaleString('en-IN')}
                            </Text>
                          </View>
                          ...
                          >
                            <Text>
                              ₹{' '}
                              {item?.TotalNetSaleValueGsT?.toLocaleString(
                                'en-IN'
                              )}
                            </Text>
                          </View>
              ...
              <>
                ...
                <View style={[styles.fitter, { marginTop: '5px' }]}>
                  <View style={[styles.mb20, { borderRadius: 8 }]}>
                    ...
                    {myBookingPayload?.constAdditionalChargesCS?.map(
                      (item, index) => (
                        <View
                          style={[
                            styles.tableRow,
...
<View
              ...
              >
                ...
                {myBookingPayload?.possessionAdditionalCostCS?.length > 0 && (
                  <>
                    <View style={[styles.ml2, styles.pt2, styles.mT1]}>
                      <Text style={[styles.subtitle1, styles.col8, styles.ml1]}>
                    ...
                    <View style={[styles.fitter, { marginTop: '5px' }]}>
                      <View style={[styles.mb20, { borderRadius: 8 }]}>
                        ...
                        {myBookingPayload?.possessionAdditionalCostCS?.map(
                          (item, index) => (
                            <View
                              style={[
                                styles.tableRow,
                            ...
                            >
                              ...
                              >
                                <Text>
                                  ₹
                                  {item?.TotalSaleValue?.toLocaleString(
                                    'en-IN'
                                  )}
                                </Text>
                              </View>
                        ...
                        <View>
                          ...
                          >
                            ...
                            <View
                              style={[styles.tableCell_35, styles.p10]}
                            ></View>
                        ...
                        [
                          {
                            ...
                            value: myBookingPayload?.T_C,
                          },
                          {
                            label: 'Construction additional Charges',
                            value: myBookingPayload?.T_D,
                          },
                          {
                            label: 'Possession Charges',
                            value: myBookingPayload?.T_E,
                          },
                        ].map((item, index) => (
                          <View
                            key={index}
                          ...
                          >
                            ...
                            <Text
                              style={{ fontSize: 9, fontWeight: 'semibold' }}
                            >
                              ₹ {item.value?.toLocaleString('en-IN')}
                            </Text>
                          </View>
        ...
        >
          ...
          >
            <View
              style={[styles.topBoderRadius, { backgroundColor: '#EDEDED' }]}
            >
              <Text
                style={[
                  // styles.subtitle1,
              ...
              >
                ...
                {myBookingPayload?.plotPS?.map((item, index) => (
                  <View
                    ...
                    key={item.id}
                    break={
                      index === myBookingPayload.plotPS.length - 1
                        ? 'after'
                        : null
                    }
                  >
                    ...
                    <View style={styles.tableCell_5}>
                      <Text>{prettyDate(item?.schDate)}</Text>
                    </View>
                ...
                <View style={[styles.totalRow, styles.mT0, styles.textcolor]}>
                  ...
                  <View
                    style={[styles.tableCell_3, styles.alignRight, styles.bold]}
                  >
                    <Text>
                      ₹{' '}
                      {(
                        myBookingPayload?.T_A +
                        myBookingPayload?.T_B +
                        myBookingPayload?.T_D
                      )?.toLocaleString('en-IN')}
                    </Text>
                  </View>
                </View>
              ...
              {myBookingPayload?.constructPS?.length > 0 && (
                <>
                  ...
                  >
                    ...
                    <View
                      style={[styles.totalRow, styles.mT0, styles.textcolor]}
                    >
                      <View style={styles.tableCell_1}></View>
                      ...
                      >
                        <Text>
                          ₹
                          {(
                            myBookingPayload?.T_C + myBookingPayload?.T_D
                          )?.toLocaleString('en-IN')}
                        </Text>
                      </View>
                    </View>
  ...
  return (
    ...
    <div>
      ...
      <PDFDownloadLink
        ...
        fileName={`${selUnitDetails?.unit_no || 'unit_no'}_${
      ...
      >
        ...
        {({ blob, url, loading, error }) =>
          loading ? (
            <div className="flex items-center  bg-white text-black     px-3 py-1  hover:scale-110  duration-200 ease-in-out  mt-4  mb-3 text-sm  border border-[1.6px]  border-[#6D28D9] tracking-wider rounded-md transition duration-200 ease-in-out focus:outline-none">
              <Download
                style={{ height: '20px', width: '14px', strokeWidth: '2.5' }}
                className="mr-2 mb-0.5 font-semibold"
              />
              <p className="text-black text-[13px] font-semibold">Cost Sheet</p>
            </div>
          ) : (
            <div className="flex items-center  bg-white px-3 py-1 text-black  hover:scale-110  duration-200 ease-in-out transition border  border-[1.6px]  border-[#6D28D9]  mt-4  mb-3 text-sm  tracking-wider rounded-md transition duration-200 ease-in-out focus:outline-none">
              <Download
                style={{ height: '20px', width: '14px', strokeWidth: '2.5' }}
                className="mr-2 mb-0.5   font-semibold"
              />
