...
const ImageUploader = () => {
  ...
  const uploadToFirebase = async (file) => {
    ...
    try {
      const uid = uuidv4();
      const storageRef = ref(storage, `uploaded_images/${uid}.png`);
