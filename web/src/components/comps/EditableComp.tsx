...
import { addCostSheetMaster,addPhasePartAtax, addPhaseFullCs, steamBankDetailsList, streamProjectMaster } from 'src/context/dbQueryFirebase'
          ...
          <table className="w-full border-collapse rounded-md">
            <thead>
              <tr className="bg-white rounded-xl">
                <th className="border border-[#e0e0e0] p-1 text-left rounded-tl-sm rounded-xl text-md">
                  Charges For
                </th>
                <th className="border border-[#e0e0e0] p-1 text-left">
                  Section
                </th>
                <th className="border border-[#e0e0e0] p-1 text-left">Unit</th>
                <th className="border border-[#e0e0e0] p-1 text-left">Price</th>
                <th className="border border-[#e0e0e0] p-1 text-left">GST</th>
                {/* <th className="border border-[#e0e0e0] p-2 text-left">
                  Description
                </th> */}
                <th className="border border-[#e0e0e0] p-1 text-left">
                        ...
                        >
                          ...
                          <td className="border border-[#e0e0e0]">
                            <input
                              ...
                              onChange={(e) =>
                                // handleChange(row.id, 'unit', e.target.value)
                                handleChange1(row.id, 'charges', e.target.value)

                              }
                              className="w-full p-1 border border-0 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                            />
                          </td>
                          <td className="border border-[#e0e0e0] ">
                            {/* <input
