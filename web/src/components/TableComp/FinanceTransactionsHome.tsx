...
import { streamGetAllTransactions } from 'src/context/dbQueryFirebase'
...
import { timeConv, prettyDate } from 'src/util/dateConverter'
...
const FinanceTransactionsHome = ({ leadsTyper }) => {
  ...
  const totalAmountCounter = (parent, searchKey) => {
    return searchKey === 'all'
      ? finFetchedData.reduce((a, b) => a + b.totalAmount, 0)
      : parent
          ?.filter(
  ...
  const serealizeData = (array) => {
    const x = ['new', 'review', 'received', 'rejected', ''].map((status) => {
                          ...
                          return (
                            <>
                              <div className="">
                                <div
                                  key={i}
                                  onClick={() => setValue(dat?.val)}
                                  className={`flex-1  min-w-64 gap-4 bg-white p-5 rounded-lg   shadow-sm  m-4  ${
                                    value === dat?.val
                                      ? ' bg-[#ffe4c4]'
                                      : 'bg-white'
                                  }`}
                                    ...
                                    >
                                      <div className="flex gap-2 flex-col">
                                        <div className="flex items-center gap-1">
                                          <span className="font-outfit font-normal text-[12px] leading-[100%] tracking-[0%] uppercase">
                                            {' '}
                                            {dat?.lab}
                                          </span>
                                        ...
                                        <h3 className="font-outfit font-medium text-[24px] leading-[100%] tracking-[2%]">
                                          ₹
                                          <CountUpComp
                                            value={totalAmountCounter(
                                              finFetchedData,
                                              dat?.val
                                            )}
                                          />
                                        </h3>
                                        <p className="font-outfit font-normal text-[12px] leading-[1] tracking-[0]">
                                          InWord: ₹
                                          {formatIndianNumber(
                                            totalAmountCounter(
                                              finFetchedData,
      ...
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d={dat.icon} />
                                    ...
                                    <div className="flex gap-6">
                                      <div className="flex items-center">
                                        ...
                                        <span className="text-green-600 font-outfit font-normal text-[12px] leading-[100%] tracking-[0%]">
                                          12%
                                        </span>
                                        <span className="font-outfit font-normal text-[12px] leading-[100%] tracking-[0%]">
                                          vs Last Week
                                      ...
                                      <div className="flex items-center">
                                        ...
                                        <span className="text-red-600 font-outfit font-normal text-[12px] leading-[100%] tracking-[0%]">
                                          12%
                                        </span>
                                        <span className="font-outfit font-normal text-[12px] leading-[100%] tracking-[0%]">
                                          vs Last Month
              ...
              <div className="mx-4 my-1 relative z-10"></div>
            </div>
                            ...
                            return (
                              ...
                              >
                                ...
                                >
                                  ...
                                  <span
                                    className={`px-1 py-1   ml-[4px] text-[14px] ${
                                      value === fieldHead?.val
                                        ? 'text-[#0E0A1F]'
                                        : 'text-gray-500'
                                    }`}
                                ...
                                >
                                  ...
                                  <td className="text-right">
                                    <span className="text-right font-semibold text-sm app-color-gray-1 mr-10">
                                      ₹{' '}
                                      {finData?.totalAmount?.toLocaleString(
                                        'en-IN'
                                      )}
                                    </span>
                                  </td>
