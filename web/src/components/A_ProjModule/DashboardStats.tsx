              ...
              <div className="flex-1 ">
                <div className="space-y-1 ">
                  <div className="grid grid-cols-3 pb-1">
                    ...
                    <div className="text-[#6A6A6A] font-medium text-xs">
                      Total
                    </div>
                    <div className="text-[#6A6A6A] font-medium text-xs">
                      Orders
                  ...
                  {metrics.map((item) => (
                    <div
                      key={item.period}
                      className="grid grid-cols-3 m-0 items-center"
                    >
                      <p
                        className={`text-xs ${
                          item.highlight
                            ? 'text-[#29AAE3] font-medium'
                            : 'text-gray-500'
                        }`}
                      >
                        {item.period}
                      ...
                      <p className="text-sm text-gray-700">{item.orders}</p>
                    </div>
                  ))}
                </div>
              </div>
                ...
                <div className="space-y-1 ">
                  ...
                  {metricsone.map((item) => (
                    ...
                    >
                      ...
                      <p className="text-sm text-gray-700">{item.secondary}</p>
                    </div>
                  ))}
                </div>
              </div>
