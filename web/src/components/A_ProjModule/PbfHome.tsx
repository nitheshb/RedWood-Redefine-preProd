...
function PdfHome() {
  ...
  const constructionCharges = [
    { description: 'Villa construction cost', rate: 4000, cost: 4004000, sqft: 8564000 }
  ];
  ...
  const paymentSchedule = [
    ...
    { schedule: 'On Execution of Agreement to Sell', timeline: 'On Agreement', amount: 1717696 },
    { schedule: 'On Execution of Sale Deed', timeline: 'On Sale Deed', amount: 5153088 }
  ];

  const constructionSchedule = [
    { schedule: 'On completion of Plinth Beam', timeline: 'On completion', amount: 2193500 },
    { schedule: 'On completion of First Floor Slab', timeline: 'On completion', amount: 2193500 },
    { schedule: 'On completion of Brick work', timeline: 'On completion', amount: 2193500 },
    { schedule: 'On completion of Plastering', timeline: 'On completion', amount: 2193500 }
  ];
            ...
            <tbody>
              ...
              <tr className="border-t border-gray-200 font-semibold">
                <td colSpan={2} className="py-3">
                  {title.includes('Plot') ? 'Plot cost' : 
                   title.includes('Additional') ? 'Additional charges' : 
                   'Construction cost'}
                </td>
                <td colSpan={2} className="py-3">₹ {total.toLocaleString()}</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div className="mt-6">
        ...
        <table className="w-full">
            ...
            <tbody>
              ...
              <tr className="border-t border-gray-200 font-semibold">
                <td colSpan={2} className="py-2">Total Cost</td>
      ...
      <div className="max-w-7xl bg-gray-50 rounded-t-[30px] mx-auto space-y-6">
        <div className="  rounded-t-[30px] shadow-sm">
            ...
            <div className="text-right">
              <h2 className="text-lg font-semibold text-gray-700">Cost sheet</h2>
          ...
          {renderChargesTable("III. Construction charges", constructionCharges)}
          {renderChargesTable("IV. Construction Additional charges", constructionAdditionalCharges)}
          
          <div className="mt-8">
            <h2 className="text-xl font-bold text-gray-800 mb-4">Payment Schedule</h2>
            <p className="text-sm text-gray-500 mb-6">When to pay & what to pay</p>
            
            {renderPaymentSchedule("I. Payment Schedule", paymentSchedule)}
            {renderPaymentSchedule("II. Construction Schedule", constructionSchedule)}
          </div>
        </div>
        </div>
      </div>
