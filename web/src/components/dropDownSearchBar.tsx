...
export default function DropDownSearchBar({
  ...
  return (
    <div
      className={`flex-shrink-0 z-10 inline-flex items-center  p-3 px-6 text-sm font-medium text-left text-gray-900  hover:bg-[#EAEBEA] hover:rounded-full focus:ring-4 focus:outline-none focus:ring-gray-100   ${
