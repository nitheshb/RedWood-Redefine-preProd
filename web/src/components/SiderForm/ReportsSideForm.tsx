...
import TodayEmployeeTaskReport from '../A_SalesModule/Reports/TodayEmployeeTasksList'
import AddTaskForm from '../AddTaskForm'

import DialogFormBody from '../DialogFormBody/DialogFormBody'


const ReportsSideForm = ({
  open,
  setOpen,
  title,
  data = {},
...
export default ReportsSideForm
