...
const CrmEmployeeAnalytics = () => {
  ...
  const getBarHeight = (units, maxHeight) =>
    `${(units / maxUnits) * maxHeight}px`
  ...
  return (
    <div className="container bg-white rounded-lg p-2">
      <div className="mb-6">
        ...
        <div
          className="flex justify-center items-end space-x-2 bg-[#fff] shadow-sm rounded-lg p-4"
          style={{ maxHeight: `${maxHeight}px`, width: '27%' }}
        >
