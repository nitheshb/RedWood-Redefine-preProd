        ...
        <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-lg">
          ...
          {payload.map((item, index) => (
            <div key={index} className="flex items-center mt-2">
              ...
              <span className="ml-auto font-semibold text-gray-800">{`${formatYAxis(
                item.value
              )}`}</span>
            </div>
          ))}
        ...
        <div className="grid grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-xl p-6  shadow-inner drop-shadow-md">
            ...
            <div className="flex items-center gap-2 text-red-500">
              ...
              <svg
                className="fill-current inline-block overflow-visible w-4 h-4 font-semibold text-orange-600"
                name="arrow-down"
          ...
          <div className="flex flex-col rounded-[30px] py-5 h-full bg-white shadow">
            <div className="w-full max-w-4xl p-6 relative">
              <div className="flex justify-between items-start mb-6">
                <div>
                  <h1 className="text-[19px] font-normal text-[#000000]">
                    Project collections
                  </h1>
                  <div className="text-[30px] font-semibold mt-2 text-[#000000]">
                    &#8377; 2613
                  </div>
                </div>
            ...
            <table className="min-w-full  bg-white ">
              <thead className="">
                ...
                <tr className="bg-[#F0F2F5] border-t border-b border-[#E8ECF4]">
                  <th
                    className="text-left p-1 pl-3 py-2 font-medium text-[#000000] whitespace-nowrap border-r border-[#E8ECF4]"
