...
import { getLastSevenMonths, getLastSevenWeeks, getLastSixYears, getNextThreeMonths } from 'src/util/dateConverter'
...
return
  ...
  return (
       <div className="flex flex-col rounded-[30px] py-5 h-full bg-white shadow">
         ...
         <div className="pt-6 px-4">
           ...
           <div className="flex items-center gap-3 mt-4 mb-4 ml-4">
             <span className="text-[30px] text-[#000000] font-semibold">&#8377; {totalCollecionR?.reduce((a,b) => a + b.value, 0)?.toLocaleString('en-US')}</span>
   ...
   <PeriodSelctorWizard timeLine={timeLineTC} setTimeLine={setTimeLineTC} />
   </section>
        {load && <div className="h-96 px-4 mt-8">
           <ResponsiveContainer width="100%" height="100%">
             <LineChart data={totalCollecionR} margin={{ top: 0, right: 30, bottom: 0, left: 0 }}>
