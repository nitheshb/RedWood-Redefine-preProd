          ...
          <div className="border-2 rounded-[30px] border-[#f1f1f1] p-4">
            <div className="flex items-center  mb-4">
              ...
              {[
                ...
                {
                  label: 'Employee Collections',
                  value: 'employee_collections',
                },
              ].map((data, i) => {
                return (
                  <section
                  ...
                  <table className="rounded-[30px] w-full max-w-7xl   my-3 overflow-hidden ">
                    <thead className="">
                      ...
                      <tr className="bg-[#F0F2F5] border-t border-b border-[#E8ECF4]">
                        <th
                          className="text-left pl-3 p-1 py-2 font-medium text-[#000000] whitespace-nowrap "
                        ...
                        {dataView === 'monthly' ? (
                          <>
                            {last3MonthsA.map((month, i) => {
                              return ['Target', 'Collection', 'Pending'].map(
                                (month, i) => {
                                  return (
                                    <th
                                      key={i}
                    ...
                    {loader &&
                      [1, 2, 3].map((d, i) => <TableSkeleton key={i} />)}
