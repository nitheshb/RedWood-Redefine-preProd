        ...
        <div className="grid grid-cols-2 gap-6 h-full items-end">
          <div className="flex flex-col rounded-[30px] py-5 h-full bg-white shadow">
            <div className="pt-6 px-4">
              <h2 className="text-[#000000] text-[19px] ml-4">
                Bookings Trend
              </h2>
          ...
          <div className="w-full max-w-7xl mx-auto">
            ...
            <div className="w-full bg-white rounded-t-[30px] overflow-hidden">
              <div className="bg-[#E0E4EB] p-4 rounded-t-[30px]">
                <h2 className="text-lg text-center font-medium text-[#000000]"></h2>
              </div>
              <div>
                    ...
                    <tbody>
                      {sortedProjects.map((item, index) => (
                        ...
                        >
                          ...
                          <td
                            className="p-2 text-gray-700  text-right"
                            onClick={() => {
                              showDrillDownFun(
                                `Total ${item?.stausTitle}`,
                                item,
                          ...
                          >
                            {item.blockedUnitCount || 0}
                          </td>
                          <td
                            className="p-2 m text-right text-gray-700"
                            onClick={() => {
                              showDrillDownFun(
                                `Total ${item?.stausTitle}`,
                                item,
