...
export default function UnitSummaryTableBodyV1({
  ...
  useEffect(() => {
    console.log('valure are', leadsFetchedData)
    const totalSale = filLeadsA.reduce(
      (total, row) => total + Number(row?.T_total || 0),
      0
    )
    setSETTotalSaleValue(totalSale)

    const totalLand = filLeadsA.reduce(
      (total, row) => total + Number(row?.T_A || 0),
      0
    )
    setSETTotalLandValue(totalLand)
    const totalChargesI = filLeadsA.reduce(
      (total, row) => total + Number(row?.T_B || 0),
      0
    )
    setSETTotalChargesIValue(totalChargesI)
    const totalConstruction = filLeadsA.reduce(
      (total, row) => total + Number(row?.T_C || 0),
      0
    )
    setSETTotalConstructValue(totalConstruction)
    const totalChargesII = filLeadsA.reduce(
      (total, row) => total + Number(row?.T_D || 0),
      0
    )
    setSETTotalChargesIIValue(totalChargesII)
    const totalPossessionII = filLeadsA.reduce(
      (total, row) => total + Number(row?.T_E || 0),
      0
    )
    setSETTotalPossessionValue(totalPossessionII)

    const totalReceived = filLeadsA.reduce(
      (total, row) => total + Number(row.T_approved || 0),
      0
    )
    setSETTotalReceived(totalReceived)
    const totalBalance = filLeadsA.reduce(
      (total, row) => total + Number(row.T_balance || 0),
      0
    )
  ...
  useEffect(() => {}, [selStatus, rowsParent])
  ...
  const computeCosts = (row) => {
    const plotCost =
      row?.plotCS?.reduce((sum, val) => sum + val.TotalNetSaleValueGsT, 0) || 0
    ...
    return (
      ...
      >
        <TableRow selected={true}>
          ...
          >
            <TableSortLabel style={{ color: '#000', fontWeight: '600' }}>
              S.No
            </TableSortLabel>
          </TableCell>
              ...
              >
                  ...
                  <div style={{}}>
                    <div className="bg-[#FFFFFF]  flex items-center justify-end py-2 pr-1">
                      <span className="text-[#000] text-[14px] ">
                        ₹{totalSETLandValue.toLocaleString('en-IN')}
                      </span>
                    </div>
                  </div>
                )}
                {headCell.id === 'partB' && (
                  <div style={{}}>
                    <div className="bg-[#FFFFFF]  flex items-center justify-end py-2 pr-1">
                      <span className="text-[#000] text-[14px] ">
                        ₹{totalSETChargesIValue.toLocaleString('en-IN')}
                      </span>
                    </div>
                  </div>
                )}
                ...
                {headCell.id === 'partC' && (
                  <div style={{}}>
                    <div className="bg-[#FFFFFF]  flex items-center justify-end py-2 pr-1">
                      <span className="text-[#000] text-[14px] ">
                        ₹{totalSETConstructValue.toLocaleString('en-IN')}
                      </span>
                    </div>
                  </div>
                )}
                ...
                {headCell.id === 'partD' && (
                  <div style={{}}>
                    <div className="bg-[#FFFFFF]  flex items-center justify-end py-1 pr-1">
                      <span className="text-[#000] text-[14px] ">
                        ₹{totalSETChargesIIValue.toLocaleString('en-IN')}
                      </span>
                    </div>
                  </div>
                )}
                {headCell.id === 'partE' && (
                  <div style={{}}>
                    <div className="bg-[#FFFFFF]  flex items-center justify-end py-1 pr-1">
                      <span className="text-[#000] text-[14px] ">
                        ₹{totalSETPossessionValue.toLocaleString('en-IN')}
                      </span>
                    </div>
                  </div>
                )}
                ...
                {headCell.id === 'sale' && (
                  <div className="bg-[#FFFFFF] flex items-center justify-end py-1 pr-1">
                    <span className="text-[#000] text-[14px] ">
                      ₹{totalSETSaleValue.toLocaleString('en-IN')}
                    </span>
                  </div>
                )}
                ...
                {headCell.id === 'received' && (
                  <div style={{}}>
                    <div className="bg-[#FFFFFF]  flex items-center justify-end py-1 pr-1">
                      <span className="text-[#000] text-[14px] ">
                        ₹{totalSETReceived.toLocaleString('en-IN')}
                      </span>
                    </div>
                  </div>
                )}
                ...
                {headCell.id === 'balance' && (
                  <div style={{}}>
                    <div className="bg-[#FFFFFF] flex items-center justify-end py-1 pr-1">
                      <span className="text-[#000] text-[14px] ">
                        ₹{selSETTotalBalance.toLocaleString('en-IN')}
                      </span>
                    </div>
                  </div>
                )}
          ...
          <div className="w-full max-w-4xl p-6 bg-white flex flex-col justify-between h-full">
            <div className="mb-6">
              ...
              <div className="flex items-center justify-between mt-1">
                <div className="text-[30px] font-semibold text-[#00000]">
                  {inventoryPayload
        ...
        <div className="border-2 rounded-[30px] border-[#f1f1f1] p-4">
          <div className=" px-4 py-2 rounded-t-[30px] bg-white flex justify-between items-center">
            ...
            <div className="relative flex gap-4">
              ...
              <button className="relative flex items-center gap-2  rounded-md border border-gray-300 hover:bg-gray-100 transition">
    ...
    Construction Download
              ...
              >
                ...
                <div className="flex-1 overflow-y-auto px-4 py-2 max-h-[60vh]">
                  ...
                  <div className="flex flex-wrap gap-2 mt-2">
                    {projectList
                      .slice(0, showMore ? projectList.length : 6)
                      .map((item) => (
                        <button
                          key={item.id}
        ...
        {costViewOptions.map((view) => (
          ...
          <div className=" max-w-7xl mx-auto rounded-2xl  ">
            <section style={{ background: '#fff', borderRadius: '15px' }}>
              <TableContainer
                sx={{ maxHeight: 640, borderRadius: '15px' }}
                  ...
                  <TableBody>
                    {filLeadsA
                      ...
                      .map((row, index) => {
                        ...
                        const legalCharge = row?.addChargesCS?.reduce(
                          (sum, item) => {
                            if (
                              item.myId ===
                              '83d81de3-1294-4e96-84bf-07294011b15e'
                            ) {
                        ...
                        const clubHouseCharges = row?.addChargesCS?.reduce(
                          (sum, item) => {
                            if (
                              item.myId ===
                              'eceb862f-3977-4e0f-a256-8c372af8cd71'
                            ) {
                              return sum + Number(item.charges)
                            }
                            return sum
                        ...
                        const maintenanceCharges = row?.addChargesCS?.reduce(
                          (sum, item) => {
                            if (
                              item.myId ===
                              '27ee5bf1-0a4e-4b01-90db-39f23b7af804'
                            ) {
                              return sum + Number(item.charges)
                            }
                            return sum
                        ...
                        const infraCharges = row?.addChargesCS?.reduce(
                          (sum, item) => {
                            if (
                              item.myId ===
                              '38bdfbbf-e4df-4b83-b7c1-086f084f8696'
                            ) {
                              return sum + Number(item.charges)
                            }
                            return sum
                            ...
                            >
                              <section>
                                <article className="flex flex-row">
                                  <span
                                    className="bg-[#ff7647] text-[#ffffff] w-5 h-5 mr-2 text-[9px] flex items-center justify-center rounded-full flex-shrink-0 font-semibold capitalize"
                                    aria-hidden="true"
                                    style={{
                                  ...
                                  >
                                    {' '}
                                    {row?.customerDetailsObj?.customerName1
                                      ?.toString()
                                      ?.charAt(0)}
                                  </span>
                        ...
                        {selectedCostView.includes("Plot Cost") && (
                          ...
                          <> */}
                            ...
                            >
                              ...
                              >
                                {/* {row?.T_A} */}
                                {Math.round(row?.T_A || 0).toLocaleString(
                                  'en-IN'
                                )}
                              </span>
                            </TableCell>
