...
import CpAgentListTable from '../cpPages/cpAgentListTable'
import SiteVisitListTable from './siteVisitListTable'



const SiteVisitListHome = ({ project }) => {
  const { user } = useAuth()
...
export default SiteVisitListHome
