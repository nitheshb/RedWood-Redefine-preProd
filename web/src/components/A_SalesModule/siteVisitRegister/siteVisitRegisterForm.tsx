...
export default function SiteVisitRegisterForm() {
  ...
  const selectLead = (lead) => {
    ...
    setFormData({
      ...
      svCPsourcedByObj: lead?.svCPsourcedByObj || {},
    ...
    <div className="max-w-4xl  p-6 bg-white rounded-b-lg shadow-lg min-w-[626px]">
      ...
      <div className="mb-8">
        <div className="flex justify-between">
          ...
          <div
            className={`flex-1 h-1 mx-2 mt-[16px] ${
          ...
          <div
            className={`flex-1 h-1 mt-[16px]  mx-2 ${
        ...
        {({ values, isSubmitting, isValid, handleSubmit, setFieldValue }) => (
          <Form className="space-y-4">
              ...
              <div className="space-y-4">
                  ...
                  values.searchPhone && (
                    <div className="bg-yellow-50 p-4 rounded-md mt-4">
                      <p className="text-yellow-700">
                        No leads found with this phone number. You can create a
                        new lead.
                      </p>
                    </div>
                  )}
                ...
                <div className="flex justify-between pt-4 mt-4">
                  ...
                  <button
                    ...
                    className={`px-4 py-2 ${
                      selectedLead ||
                      (values.searchPhone && searchResults.length === 0)
                        ? 'bg-blue-500 hover:bg-blue-600'
                        : 'bg-blue-300'
            ...
            {step === 3 && (
              <div className="space-y-4">
                <h2 className="text-xl font-semibold text-gray-800">
                  To be filled by Office Staff only
                </h2>
                <div className="bg-yellow-50 p-3 rounded-md mb-4">
                  <p className="text-yellow-700 text-sm">
                    This section is restricted to office staff only.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <CustomSelect
                    ...
                    onChange={(value) => {
                      ...
                      setFieldValue('svSchBy', value.value)
                ...
                <div>
                  ...
                  <CustomSelect
                    ...
                    onChange={(value) => {
                      console.log('value is ', value, user)
                      setFieldValue('svAttendedBy', value.value)
