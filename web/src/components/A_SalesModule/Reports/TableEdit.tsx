...
const TableEdit = ({ data }) => {
  ...
  const editRow = (index: number) => {
    ...
    if (
      rowToEdit.chargesFor.trim() === '' ||
      rowToEdit.units.trim() === '' ||
      rowToEdit.charges === 0 ||
      rowToEdit.gst === 0 ||
      rowToEdit.description.trim() === ''
    ) {
  ...
  return (
    <div className="container mx-auto p-4">
      <table className="table-fixed border-collapse border-none">
        <thead>
          <tr>
            <th className="border-t border-r border-b border-gray-300 px-4 py-2  text-gray-400 text-left text-sm">
              Charges For*
            </th>
            <th className="border border-gray-300 px-4 py-2  text-gray-400 text-left text-sm">
              Units*
            </th>
            <th className="border border-gray-300 px-4 py-2  text-gray-400 text-left text-sm">
              Charges*
            ...
            <th className="border-t border-l border-b border-gray-300 px-4 py-2  text-gray-400 text-left text-sm">
              Actions*
            </th>
          </tr>
        </thead>
        <tbody>
          ...
          <tr>
            ...
            >
              <div
                onClick={addRow}
                className="w-full  text-gray-800 rounded cursor-pointer"
              >
