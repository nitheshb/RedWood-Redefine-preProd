...
import EmployeePerformanceStakBar from './EmpPerformanceStackBar'

const EmployeePerformanceHome = ({
  sourceRawFilData,
  showDrillDownFun,
  leadsFetchedRawData,
  projectFilList,
...
export default EmployeePerformanceHome
