...
import LeadsDisplayTable from 'src/components/PreSaleModule/LeadsManagement/LeadsDisplayTable'
import LeadControllerOptions from './LeadControllersOptions'


export default function LeadsControllerBody({ todaySch, schLoading }) {
  const { user } = useAuth()
