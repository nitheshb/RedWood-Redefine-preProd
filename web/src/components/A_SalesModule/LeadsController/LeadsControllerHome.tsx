...
import LeadsLakeHomeComponent from 'src/components/PreSaleModule/LeadsManagement/LeadsLakeHomeComponent'
import {
  getLeadbyId1,
...
import LeadsControllerBody from './LeadsControllerBody'

const LeadsControllerHome = ({ taskType }) => {
  // change navbar title
...
export default LeadsControllerHome
