  ...
  return (
    ...
    <section className='shadow-[0_0_0_1px_rgba(0,0,0,0.08)]  border-[0.5px] rounded-md  p-4'>
      <div className='flex flex-col space-y-1.5 p-6'>
          <div className='text-[#171717] text-lg  font-[Outfit] font-semibold leading-none tracking-tight'>Re-Engagement Criteria</div>
...
export default ReEngageCriteria
