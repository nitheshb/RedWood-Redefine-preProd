...
const Stepper = ({ id, streamCurrentStatus, streamCoveredA, tempLeadStatus, streamfrom, setStatusFun }) => {
        ...
        <div key={i} className="flex flex-col items-center">
          ...
          <div 
            className={`w-8 h-8 flex items-center justify-center rounded-full border-2 mb-1 ${
              streamCoveredA.includes(statusFlowObj.value) || statusFlowObj.value === streamfrom
            ...
            style={{
              ...(hover && hoverId === i ? { boxShadow: '0 0 0 4px rgba(79, 70, 229, 0.2)' } : {}),
              cursor: 'pointer',
            }}
          >
            {streamCoveredA.includes(statusFlowObj.value) || statusFlowObj.value === streamfrom ? (
