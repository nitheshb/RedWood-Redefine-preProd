...
import { ChevronDown, ChevronUp, Clock, PlusCircle, ChevronRight, FileText, MessageSquare } from 'lucide-react';
    ...
    <div>
      ...
      <div className="flex flex-wrap text-gray-600 mt-2 mb-4">
        <div className="flex items-center mr-6 mb-2">
          <span className='font-normal text-[14px] text-[#606062] font-outfit'>20 Mar 2025, 10:57 am</span>
      ...
      <div className="flex items-start">
        ...
        <div className="font-normal text-[14px]  text-[#606062] font-outfit">
          <span className="font-medium">Recent Comments:</span> Villa is nice and good infrastructure
        </div>
      </div>
    </div>
            </div>
...
<div className="space-y-4">
    ...
    <div className="flex items-center mb-4">
      ...
      <span className="font-semibold text-[12px] text-[#696990] leading-[100%] tracking-[0.06em] uppercase">ASSIGNED TO</span>
    </div>
    ...
    >
      <div className='flex flex-col gap-2'>
        <div className="font-medium text-[12px] leading-[100%] tracking-[0em] text-[#404040]">{projectData.assignedTo[0].name}</div>
        <div className="font-normal text-[12px] leading-[100%] tracking-[0em] text-[#666666]">{projectData.assignedTo[0].date}</div>
      </div>
      {isAssignedExpanded ? 
